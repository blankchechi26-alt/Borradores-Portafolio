...
# Garantizar DataFrame incluso cuando es 1 ticker
...
sharpe = (mean_ret - 0.02) / vol  # 2% risk-free

# ✅ Ajuste crítico: pesos siempre dimensión-compatible
...
ax.set_title("Evolución del valor")
ax.legend()
st.pyplot(fig)
